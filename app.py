...
def get_column_name (schemas , ds_name , sorting_key= 'column_position'):
 ...
 #قراءة البيانات من ملفات المصدر إلى الداتافيم + جوا اسماء الأعمدة اسماء المجموعة بتاعتهم   
...
#تحديد المسار و الطريقة الى هتتبنى بيها البيانات
...
#الحصول على الملفات المتعلقة بمجموعة محددة من البيانات
